...
namespace dismec::postproc {
    struct IdentityPostProc : public PostProcessor {
        ...
        void process(label_id_t label_id,
                     Eigen::Ref<DenseRealVector> weight_vector,
                     solvers::MinimizationResult& result) override {};
    };
    ...
    void CullingPostProcessor::process(label_id_t label_id,
                                       Eigen::Ref<DenseRealVector> weight_vector,
    ...
    CullingPostProcessor::CullingPostProcessor(const std::shared_ptr<objective::Objective>& objective,
